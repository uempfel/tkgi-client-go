...
// WithProfileName adds the profileName to the delete network profile params
func (o *DeleteNetworkProfileParams) WithProfileName(profileName string) *DeleteNetworkProfileParams {
	o.SetProfileName(profileName)
	return o
}

// SetProfileName adds the profileName to the delete network profile params
func (o *DeleteNetworkProfileParams) SetProfileName(profileName string) {
