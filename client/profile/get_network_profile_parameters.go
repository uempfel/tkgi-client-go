...
// WithProfileName adds the profileName to the get network profile params
func (o *GetNetworkProfileParams) WithProfileName(profileName string) *GetNetworkProfileParams {
	o.SetProfileName(profileName)
	return o
}

// SetProfileName adds the profileName to the get network profile params
func (o *GetNetworkProfileParams) SetProfileName(profileName string) {
