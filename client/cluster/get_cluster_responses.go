...
func (o *GetClusterOK) Error() string {
	return fmt.Sprintf("[GET /v1/clusters/{clusterName}][%d] getClusterOK  %+v", 200, o.Payload)
}
...
func (o *GetClusterUnauthorized) Error() string {
	return fmt.Sprintf("[GET /v1/clusters/{clusterName}][%d] getClusterUnauthorized ", 401)
}
...
func (o *GetClusterForbidden) Error() string {
	return fmt.Sprintf("[GET /v1/clusters/{clusterName}][%d] getClusterForbidden ", 403)
}
...
func (o *GetClusterNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/clusters/{clusterName}][%d] getClusterNotFound  %+v", 404, o.Payload)
}
func (o *GetClusterNotFound) GetPayload() *models.ErrorResponse {
	return o.Payload
}
