...
// WithClusterName adds the clusterName to the create user params
func (o *CreateUserParams) WithClusterName(clusterName string) *CreateUserParams {
	o.SetClusterName(clusterName)
	return o
}

// SetClusterName adds the clusterName to the create user params
func (o *CreateUserParams) SetClusterName(clusterName string) {
