...
// WithOwner adds the owner to the get usage params
func (o *GetUsageParams) WithOwner(owner string) *GetUsageParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the get usage params
func (o *GetUsageParams) SetOwner(owner string) {
	o.Owner = owner
}
